...
{
    /// <inheritdoc />
    public partial class Fix_StudentInvite : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentInvite", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentInvite_DrivingSchools_DrivingSchoolId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentInvite_DrivingSchoolId",
                table: "StudentInvite",
